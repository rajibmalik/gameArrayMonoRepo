...
router.get(
  ...
  gamesController.createGames, // Create and updates Game documents in MongoDB
  userGamesController.createAndUpdateUserGames, // Creates UserGame documents in MongoDB
